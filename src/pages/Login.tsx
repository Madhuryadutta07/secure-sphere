          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {isSignup && (
              <div className="space-y-2">
                ...
                <Input placeholder="John Doe" className="bg-secondary/50 border-border/50 h-11" />
              </div>
            )}
            <div className="space-y-2">
            ...
            <Button type="submit" className="w-full h-11 bg-gradient-primary text-primary-foreground font-semibold">
              {isSignup ? "Create Account" : "Login"} <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </form>
